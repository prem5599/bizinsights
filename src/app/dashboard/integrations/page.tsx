    ...
    return (
      <DashboardLayout>
        <div className="text-center py-12">
          <Puzzle className="h-12 w-12 text-blue-500 mx-auto mb-4" />
          <h2 className="text-xl font-semibold text-slate-900 mb-2">Sign In Required</h2>
          <p className="text-slate-600">Please sign in to manage your integrations.</p>
        </div>
      </DashboardLayout>
    )
  }
    ...
    <DashboardLayout>
      <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">
                Connect your business tools to unlock powerful analytics
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg border border-slate-200">
            <div className="text-2xl font-bold text-green-600">{data?.connectedCount || 0}</div>
            <div className="text-sm text-slate-600">Connected</div>
          </div>
          <div className="bg-white p-4 rounded-lg border border-slate-200">
            <div className="text-2xl font-bold text-slate-600">
              {availableIntegrations.length - (data?.connectedCount || 0)}
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {data.integrations.map((integration) => {
                ...
                return (
                  <div key={integration.id} className="bg-white rounded-lg border border-slate-200 p-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {availableIntegrations.map((integration) => {
              ...
              return (
                <div key={integration.id} className="bg-white rounded-lg border border-slate-200 p-6 hover:shadow-md transition-shadow">
